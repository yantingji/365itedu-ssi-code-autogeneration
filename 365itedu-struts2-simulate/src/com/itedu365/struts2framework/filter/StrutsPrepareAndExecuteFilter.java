package com.itedu365.struts2framework.filter;
...
import com.itedu365.struts2.config.ActionConfig;
import com.itedu365.struts2.config.ResultConfig;
import com.itedu365.struts2framework.action.ActionContext;
import com.itedu365.struts2framework.action.ActionProxy;
import com.itedu365.struts2framework.action.ValueStack;
import com.itedu365.struts2framework.result.Result;
import com.itedu365.struts2framework.wrapper.Itedu365RequestWrapper;
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        if (request instanceof HttpServletRequest) {
            try {
                ...
                Result.getInstance(type, path).execute(new Itedu365RequestWrapper((HttpServletRequest) request), (HttpServletResponse) response);
